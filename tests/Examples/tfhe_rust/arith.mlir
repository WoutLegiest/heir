module attributes {tf_saved_model.semantics} {
  func.func @test_affine(%arg0: !tfhe_rust.server_key, %arg1: memref<1x1x!tfhe_rust.eui32>) -> memref<1x1x!tfhe_rust.eui32> {
    ...
    %2 = affine.load %arg1[0, 0] : memref<1x1x!tfhe_rust.eui32>
