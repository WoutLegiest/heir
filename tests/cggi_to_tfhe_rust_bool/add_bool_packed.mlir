// RUN: heir-opt --cggi-boolean-line-vectorize -cse --cggi-to-tfhe-rust-bool -remove-dead-values %s | FileCheck %s
...
// CHECK-NOT: cggi
// CHECK-NOT: lwe
// CHECK-COUNT-1: tfhe_rust_bool.packed %arg0, {{%.*}}, {{%.*}} {gates = #tfhe_rust_bool.tfhe_rust_bool_gate<"and", "xor">} : (!tfhe_rust_bool.server_key, tensor<2x!tfhe_rust_bool.eb
