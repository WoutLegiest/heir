  ...
  WalkResult failIfInterrupted = funcOp.walk([&](Operation *op) {
    return TypeSwitch<Operation *, WalkResult>(op)
        ...
        .Case<ModuleOp, func::FuncOp, func::ReturnOp, func::CallOp,
              ...
              affine::AffineStoreOp, affine::AffineParallelOp,
              affine::AffineForOp, arith::ConstantOp, arith::IndexCastOp,
              arith::ShLIOp, arith::AndIOp, arith::ShRSIOp, arith::TruncIOp,
              arith::ExtSIOp, tensor::ExtractOp, tensor::FromElementsOp,
              tensor::InsertOp, memref::AllocOp, memref::DeallocOp,
