...
class CGGIToTfheRust : public impl::CGGIToTfheRustBase<CGGIToTfheRust> {
  void runOnOperation() override {
    ...
    // needed and possible.
    patterns.add<
        AddServerKeyArg, AddServerKeyArgCall, ConvertAndOp, ConvertEncodeOp,
        ConvertLut2Op, ConvertLut3Op, ConvertNotOp, ConvertOrOp,
        ConvertTrivialEncryptOp, ConvertXorOp, ConvertTrivialOp, ConvertMulOp,
        ConvertAddOp, ConvertSubOp, ConvertCastOp, ConvertShROp,
